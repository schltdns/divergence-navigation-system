...
Previous version: v2.0 – 10.5281/zenodo.19513073
...
See `dns_open_data_proof.json`
---
Attribution & License
Dual licensing:
Code (JSON schema, Python): Apache-2.0
Documentation & Method: CC BY-NC-SA 4.0
...
Full description: docs/HOW_IT_WORKS.md
---
🎯 Why DNS matters
...
Report – OPERATIONALIZATION_REPORT.md
---
📖 Glossary
Δdiv: `0.5×(1-Jaccard) + 0.5×(1-Cosine)`
Four Questions Method: frontend for learners
Safety Layer: EU-compliant backend
P1–P8: 8-step protocol – see protocol/README.md
Full: docs/MATH_AND_GLOSSARY.md
---
⚠️ Guardrails
Low Δdiv ≠ Truth
High Δdiv ≠ Error
...
---
📦 Case Studies
Labour Market 2030 – Δdiv 0.6256, first complete P1-P8 run (v2.1)
Cognitive Safety
Energy
---
📂 Structure
...
🚀 Quick Start
Read BENCHMARK.md
Read OPERATIONALIZATION_REPORT.md
Run your own Δdiv test
---
✍️ Citation
